            ...
            <div className='text-base text-center mx-auto'>
                <div className='bg-yellow-300 py-4 flex flex-col lg:flex-row items-center mx-auto'>
                    ...
                    <div className='lg:mt-0 mt-1 mx-auto'>
                        <p className='lg:w-full lg:text-3xl text-2xl w-1/2 mx-auto border-b-2 border-yellow-500 text-orange-700 font-bold' style={{ fontFamily: 'French Script MT' }}>Fazendo Sua Festa Deliciosamente Inesquecível</p>
